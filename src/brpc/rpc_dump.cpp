...
#define DUMPED_FILE_PREFIX "requests"
    ...
    public:
        ...
        RpcDumpContext()
            : _cur_req_count(0), _cur_fd(-1), _last_round(0), _max_requests_in_one_file(0), _max_files(0), _sched_write_time(butil::gettimeofday_us() + FLUSH_TIMEOUT), _last_file_time(0)
        {
