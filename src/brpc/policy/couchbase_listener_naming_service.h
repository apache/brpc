...
#ifndef  BRPC_POLICY_COUCHBASE_LISTENER_NAMING_SERVICE
#define  BRPC_POLICY_COUCHBASE_LISTENER_NAMING_SERVICE
...
// It is only used for CouchbaseServerListener. It updates servers for listen channel 
...
class CouchbaseListenerNamingService : public PeriodicNamingService {
friend CouchbaseServerListener;
private:
...
#endif  //BRPC_POLICY_COUCHBASE_LISTENER_NAMING_SERVICE
