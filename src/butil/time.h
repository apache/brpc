...
// Only computed when BUTIL_USE_CPU_FREQUENCY is defined.
...
#if !defined(BAIDU_INTERNAL) && !defined(BUTIL_USE_CPU_FREQUENCY)
...
#endif // defined(BAIDU_INTERNAL) || defined(BUTIL_USE_CPU_FREQUENCY)
}
