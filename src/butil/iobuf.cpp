...
size_t IOBuf::cutn_from_gpu(IOBuf* out, size_t n) {
    ...
    butil::gdr::BlockPoolAllocator* host_allocator = butil::gdr::BlockPoolAllocators::GetInstance()->get_cpu_allocator();
...
size_t IOBuf::copy_from_gpu(void* d, size_t n, size_t pos, bool to_gpu) const {
    ...
    butil::gdr::GPUStreamPool* gpu_stream_pool = butil::gdr::BlockPoolAllocators::GetInstance()->get_gpu_stream_pool();
    size_t m = n;
