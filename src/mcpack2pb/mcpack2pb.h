...
static const MessageHandler INVALID_MESSAGE_HANDLER = {nullptr, nullptr, nullptr, nullptr};
...
// If the handler was not registered, function pointers inside are nullptr.
...
inline bool MessageHandler::serialize_to_iobuf(
    ...
    if (serialize == nullptr) {
        LOG(ERROR) << "`serialize' is nullptr";
        return false;
    }
