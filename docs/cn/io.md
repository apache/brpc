...
和fd相关的数据均在[Socket](http://icode.baidu.com/repo/baidu/opensource/brpc/files/master/blob/src/brpc/socket.h)中，是rpc最复杂的结构之一，这个结构的独特之处在于用64位的SocketId指代Socket对象以方便在多线程环境下使用fd。常用的三个方法：
