...
* Make sure the [travis-ci](https://travis-ci.org/github/apache/incubator-brpc/pull_requests) passed.
...
* [travis-ci](https://travis-ci.org/github/apache/incubator-brpc/pull_requests)成功通过。
