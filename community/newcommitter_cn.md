# 这里记录发展Committer 和 PMC成员的流程和参考网站信息
...
3. 提名者给被提名者发invite letter并提示他提交ICLA([邮件模板](https://community.apache.org/templates/committer-invite.txt))
...
1. 加为committer
<https://whimsy.apache.org/roster/committee/brpc>
...
4. 在private@brpc中和dev中announce new PMC
5. 设定他的权限，通过访问 https://whimsy.apache.org/roster/committee/brpc
6. 帮他订阅private邮件组，参见 https://whimsy.apache.org/committers/moderationhelper.cgi
