...
DEFINE_int32(operations_per_thread, 50, "Number of operations each thread should perform");
...
void* thread_worker(void* arg) {
    ...
    LOG(INFO) << "Thread " << args->thread_id << " connected to bucket " << args->bucket_name;
...
void get_config() {
    std::cout << CYAN << "=== Simple Multithreaded Couchbase Client ===" << RESET << std::endl;
