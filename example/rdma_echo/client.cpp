...
// A client sending requests to server by rdma protocol.
...
DEFINE_int32(attachment_size, 4096, "Carry so many byte attachment along with requests");
DEFINE_int32(request_size, 16, "Bytes of each request");
DEFINE_string(connection_type, "", "Connection type. Available values: single, pooled, short");
DEFINE_string(server, "0.0.0.0:8004", "IP Address of server");
...
static void* sender(void* arg) {
    ...
    attachment.append(g_attachment);
